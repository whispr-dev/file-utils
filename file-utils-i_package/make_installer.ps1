...
if (Test-Path $exePath) {
    ...
    $checksumContent = @"
file-utils-i v0.3.1 - SHA256 Checksum
=====================================
...
"@
    ...
    $checksumPath = Join-Path -Path (Get-Location) -ChildPath "checksums.txt"
...
$outputFiles = @("file-utils-i_installer.exe", "file-utils-i_installer.ps1", "file-utils-i_installer.bat", "archive.7z", "checksums.txt")
